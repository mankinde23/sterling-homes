  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "modal-con": "rgba(33, 33, 33, 0.75)",
        "modal-main": "rgba(0, 0, 0, 0.77)",
        "stroke-main": "rgba(255, 255, 255, 0.17)",
        "contact-section": "rgba(11, 11, 11, 0.61)",
        "footer-b": "#0B0B0B",
        "footer-s": "rgba(255, 255, 255, 0.09)",
        "copy-t": "rgba(164, 163, 163, 0.80)",
        "footer-test": "#EAEAEA",
        "text-error": "rgba(249, 75, 75, 1)",
        "catalogue-stroke": "rgba(234, 231, 231, 0.16)",
        "footer-test1": "#E0E0E0",
        "sterling-hover": "#02F28D",
        "link-hover": "#A2A2A2",
      },
    },
    screens: {
