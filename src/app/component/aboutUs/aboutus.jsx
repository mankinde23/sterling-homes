  ...
  return (
    <>
      ...
      <div className="2xl:hidden 2xl-max:hidden xl:hidden lg:hidden sm:block md:hidden">
        <div
          className={`h-[68.125rem] w-auto  px-[1.87rem]  ${
            theme === "dark"
              ? "bg-about-bg transition duration-500 ease-in-out"
              : "bg-nav-text transition duration-500 ease-in-out"
          }`}
          id="about"
        >
          <div className="flex  justify-between gap-[1.75rem] items-center pt-[3.06rem] flex-col">
            <div>
              <div className="h-[2.3125rem]">
                <h1
                ...
                <p className=" text-sterling-theme text-[0.4375rem] font-medium leading-[0.105rem] mt-[0.25rem]">
                  Est . 2024, March.
                </p>
              </div>
              <div>
                <Image
                  src={mock}
                  alt=""
                  className="w-[20.625rem] mt-[1.38rem]"
                />
              </div>
            </div>
            <div className=" h-[18.5rem] w-auto text-justify hyphens-auto">
              <p
          ...
          <div className="flex flex-col justify-between items-center mt-[3.94rem] w-auto h-[24.43rem] ">
            <div className="flex flex-col gap-[0.81rem] w-auto ">
              <p
