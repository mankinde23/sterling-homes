...
export default function Catalogue() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`h-[183.1875rem] px-[1.88rem] ${
            theme === "dark"
              ? "bg-about-bg transition duration-500 ease-in-out"
              : "bg-nav-text transition duration-500 ease-in-out"
          }`}
        >
          ...
          <div className="grid grid-cols-1 auto-rows-auto gap-y-[2rem] mt-[3.81rem]">
            <div className="flex justify-center  flex-col gap-[2rem]">
              <div
                className="bg-cover w-auto h-[32.5rem] pt-[1.5625rem] gap-[15.44rem] bg-light-gray bg-no-repeat flex-shrink-0  scale-100 flex flex-col"
                style={{
                  backgroundImage: "url('catalogue1mt.png')",
                }}
              >
                <div className="flex justify-end w-full">
                  <div className="w-[8.125rem] h-[2.5254rem]  px-[1.19rem] bg-sterling-theme justify-center flex-col items-start">
                    <p
                      className="text-[0.75rem] font-medium leading-[1rem] text-nav-text my-[0.76rem]"
                      style={{ fontFamily: "Roboto, sans-serif" }}
                    >
                ...
                <div className="w-auto h-[13.8125rem] bg-navbar-bg backdrop-blur-[11.5px] ">
                  <div className="w-[7.712rem] h-[1.3125rem] flex gap-[0.5rem] items-center ml-[1.25rem] mt-[1.25rem]">
                    <FaLocationDot className="text-nav-text" />
                    <p className="text-nav-text text-[1rem] font-medium leading-normal">
                      Atlanta, GA
              ...
              <div
                className="bg-cover w-auto h-[32.5rem] pt-[18.69rem]  bg-light-gray bg-no-repeat flex-shrink-0  scale-100 flex flex-col"
                style={{
                  backgroundImage: "url('catalogue2mt.png')",
                }}
              >
                <div className="w-auto h-[13.8125rem] bg-navbar-bg backdrop-blur-[11.5px] ">
                  <div className="w-[7.712rem] h-[1.3125rem] flex gap-[0.5rem] items-center ml-[1.25rem] mt-[1.25rem]">
              ...
              <div
                className="bg-cover w-auto h-[32.5rem] pt-[18.69rem]  bg-light-gray bg-no-repeat flex-shrink-0  scale-100 flex flex-col"
                style={{
                  backgroundImage: "url('catalogue3mt.png')",
                }}
              >
                <div className="w-auto h-[13.8125rem] bg-navbar-bg backdrop-blur-[11.5px] ">
                  <div className="w-[7.712rem] h-[1.3125rem] flex gap-[0.5rem] items-center ml-[1.25rem] mt-[1.25rem]">
              ...
              <div
                className="bg-cover w-auto h-[32.5rem] pt-[18.69rem]  bg-light-gray bg-no-repeat flex-shrink-0  scale-100 flex flex-col"
                style={{
                  backgroundImage: "url('catalogue4mt.png')",
                }}
              >
                {" "}
                <div className="w-auto h-[13.8125rem] bg-navbar-bg backdrop-blur-[11.5px] ">
              ...
              <div
                className="bg-cover w-auto h-[32.5rem] pt-[18.69rem]  bg-light-gray bg-no-repeat flex-shrink-0  scale-100 flex flex-col"
                style={{
                  backgroundImage: "url('catalogue5mt.png')",
                }}
              >
                <div className="w-auto h-[13.8125rem] bg-navbar-bg backdrop-blur-[11.5px] ">
                  <div className="w-[7.712rem] h-[1.3125rem] flex gap-[0.5rem] items-center ml-[1.25rem] mt-[1.25rem]">
